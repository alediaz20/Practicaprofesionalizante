...
mounted:function(){
	...
	methods:{
		mostrarArticulos:function(){
			axios.post("http://localhost/agenda/php/listar.php")
		...
		mostrarRubros:function(){
			axios.get("http://localhost/agenda/php/rubros.php")
			.then(function(response){
		...
		ingresarArticulos:function(){
			...
			formdata.append("id_rubro",this.articuloRegistro.id_rubro);
 			...
 			axios.post("http://localhost/agenda/php/ingresar.php",formdata)
			.then(function(response){
...
console.log(this.articuloRegistro);
 			axios.post("http://localhost/agenda/php/editar.php",formdata)
			.then(function(response){
				app.mostrarMensaje=false;
				app.mensaje=response.data.mensaje;
	/*
	...
	*/
		...
		//	formdata.append("nombre",this.articuloRegistro.nombre);
 			...
 			axios.post("http://localhost/agenda/php/eliminar.php",formdata)
			.then(function(response){
				app.mostrarMensaje=false;
				app.mensaje=response.data.mensaje;
	/*
